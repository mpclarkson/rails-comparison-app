...
class ExchangeRatesControllerTest < ActionController::TestCase
  ...
  test "should create exchange_rate" do
    assert_difference('ExchangeRate.count') do
      post :create, exchange_rate: { from_currency: @exchange_rate.from_currency, rate: @exchange_rate.rate, to_currency: @exchange_rate.to_currency }
    end
  ...
  test "should update exchange_rate" do
    patch :update, id: @exchange_rate, exchange_rate: { from_currency: @exchange_rate.from_currency, rate: @exchange_rate.rate, to_currency: @exchange_rate.to_currency }
    assert_redirected_to exchange_rate_path(assigns(:exchange_rate))
  end

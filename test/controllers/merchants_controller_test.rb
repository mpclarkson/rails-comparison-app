...
class MerchantsControllerTest < ActionController::TestCase
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post :create, merchant: { description: @merchant.description, merchant_id: @merchant.merchant_id, name: @merchant.name }
    end
  ...
  test "should update merchant" do
    patch :update, id: @merchant, merchant: { description: @merchant.description, merchant_id: @merchant.merchant_id, name: @merchant.name }
    assert_redirected_to merchant_path(assigns(:merchant))
  end
